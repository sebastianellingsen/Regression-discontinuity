...
- Each unit has a *running variable*, *X~i~*.

- There is a common cutoff, *c*.

- Units with *X~i~≥ c* are assigned to the treatment condition, while units with *X~i~ < c* are  assigned  to  the  control  condition.

- This  assignment rule is  defined  as *T~i~=1(X~i~≥c)*.
